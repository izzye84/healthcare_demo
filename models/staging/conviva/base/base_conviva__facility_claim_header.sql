...
source_renamed as (
    ...
    select facility_header_claim_id as identifier_claim_header,
           ...
           paid_amount :: numeric(18,2) as total,
           ...
           to_date(service_date_from, 'yyyy-mm-dd') as billable_period_start,
           to_date(service_date_to, 'yyyy-mm-dd') as billable_period_end,

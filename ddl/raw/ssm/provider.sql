...
stored as textfile
location 's3://strive-analytics-warehouse-pro/clients/client_id=ssm/data_frequency=batch/provider/'
...
location 's3://strive-analytics-warehouse-pro/clients/client_id=ssm/data_frequency=batch/provider/ingest_date=2020-03-01/';

alter table raw_ssm.provider add
partition(client_id='ssm', ingest_date='2020-03-16') 
location 's3://strive-analytics-warehouse-pro/clients/client_id=ssm/data_frequency=batch/provider/ingest_date=2020-03-16/';

alter table raw_ssm.provider add
partition(client_id='ssm', ingest_date='2020-04-01') 
location 's3://strive-analytics-warehouse-pro/clients/client_id=ssm/data_frequency=batch/provider/ingest_date=2020-04-01/';

alter table raw_ssm.provider add
partition(client_id='ssm', ingest_date='2020-05-01') 
location 's3://strive-analytics-warehouse-pro/clients/client_id=ssm/data_frequency=batch/provider/ingest_date=2020-05-01/';

alter table raw_ssm.provider add
partition(client_id='ssm', ingest_date='2020-06-01') 
location 's3://strive-analytics-warehouse-pro/clients/client_id=ssm/data_frequency=batch/provider/ingest_date=2020-06-01/';

alter table raw_ssm.provider add
partition(client_id='ssm', ingest_date='2020-07-01') 
location 's3://strive-analytics-warehouse-pro/clients/client_id=ssm/data_frequency=batch/provider/ingest_date=2020-07-01/';

alter table raw_ssm.provider add
partition(client_id='ssm', ingest_date='2020-08-01') 
location 's3://strive-analytics-warehouse-pro/clients/client_id=ssm/data_frequency=batch/provider/ingest_date=2020-08-01/';
...
stored as textfile
location 's3://some_company-analytics-warehouse-pro/clients/client_id=humana/data_frequency=batch/demographics/'
...
location 's3://some_company-analytics-warehouse-pro/clients/client_id=humana/data_frequency=batch/demographics/ingest_date=2020-06-15/';